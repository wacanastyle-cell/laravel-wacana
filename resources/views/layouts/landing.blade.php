...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}
        ...
        .drawer-links a:hover{background:#18181b;color:#fff}
...
<header class="top-nav">
    <div class="nav-inner">
        <a href="#home" class="brand" aria-label="Wacana Style">
            <div class="brand-mark"><i class="fa-solid fa-motorcycle"></i></div>
            <div>
                WACANA STYLE
                <small>COMMUNITY • JAWA TENGAH</small>
            </div>
        </a>
        ...
        <nav class="nav-links">
            ...
            <a href="#jacket">Jaket</a>
            <a href="#faq">FAQ</a>
        </nav>

        <button class="menu-btn" type="button" onclick="toggleDrawer()" aria-label="Buka menu">
    ...
    <section id="gallery" class="section section-dark">
        <div class="container">
            ...
            <div class="gallery-grid reveal">
                ...
                <div class="g-item g-item--wide" onclick="openLightbox(9)">
                    <img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjOmb_3Xc0zC75nlzZpfvLPHQgIunsGzwnsgP5fFKeoNknIs38P6PLUIxX2ZN6O0PXjANvzMiHKQG-r1EQ2u-sVnwyoSXE9omhSSv9ycEpK1oLPeUKlsKCoMop35A429xAW1qPSD-IyyDWtKM-qyVvRCIXbEbvCYq0nu3m2Mn_2u9J6mQk/s1600/image1786105932=crop" alt="Satu Aspal" loading="lazy">
                    <div class="g-zoom"><i class="fa-solid fa-expand"></i></div>
                    <div class="g-overlay"><span class="g-tag">Family</span><span class="g-caption">Satu Aspal</span></div>
                </div>
    ...
    <section id="join" class="section section-dark">
        <div class="container">
            <div class="section-head reveal">
                ...
                <p class="section-desc">
                    Isi data singkat di bawah. Setelah dikirim, WhatsApp akan dibuka untuk admin komunitas.
                </p>
            </div>
            ...
            <div class="form-grid">
                <div class="glass-card form-card reveal">
                    ...
                    <form id="joinForm">
                        ...
                        <div id="joinSuccess" class="form-status status-success hidden">
                            ...
                            Data siap diteruskan ke admin WhatsApp.
                        </div>
                ...
                <div id="jacket" class="glass-card order-card reveal">
                    <div class="jacket-preview">
                        <i class="fa-solid fa-vest"></i>
                    </div>
                    <h3>Jaket Wacana Style</h3>
                    <p>Jaket komunitas dengan bonus gantungan kunci dan stiker Wacana Style.</p>

                    <div class="price">
                        <div>
                            <span>Mulai dari</span>
                            <strong id="priceDisplay">Rp 180.000</strong>
                        </div>
                        <span>/ pcs</span>
                    </div>

                    <div style="font-size:10px;color:#71717a;text-transform:uppercase;font-weight:800;letter-spacing:.1em">Pilih Ukuran</div>
                    <div class="size-grid">
                        <button type="button" class="size-btn active" data-extra="0" data-size="S">S</button>
                        <button type="button" class="size-btn" data-extra="0" data-size="M">M</button>
                        <button type="button" class="size-btn" data-extra="0" data-size="L">L</button>
                        <button type="button" class="size-btn" data-extra="15000" data-size="XL">XL +15K</button>
                    </div>

                    <div style="font-size:10px;color:#71717a;text-transform:uppercase;font-weight:800;letter-spacing:.1em">Jumlah</div>
                    <div class="qty-row">
                        <button type="button" class="qty-btn" onclick="adjustQty(-1)"><i class="fa-solid fa-minus"></i></button>
                        <div id="qtyValue" class="qty-value">1 pcs</div>
                        <button type="button" class="qty-btn" onclick="adjustQty(1)"><i class="fa-solid fa-plus"></i></button>
                    </div>

                    <button type="button" class="btn btn-red" style="width:100%" onclick="openJacketModal()">
            ...
            <div class="faq-list reveal">
                <div class="faq-item">
                    <button class="faq-question" type="button" onclick="toggleFaq(this)">
                        Apakah semua jenis motor boleh bergabung?
                        <i class="fa-solid fa-chevron-down"></i>
                    </button>
                    <div class="faq-answer">
                        Pada prinsipnya Wacana Style terbuka untuk rider dari berbagai jenis motor.
                        Yang paling penting adalah sikap, solidaritas, dan kemauan menjaga nama baik komunitas.
                    </div>
                </div>

                <div class="faq-item">
                    <button class="faq-question" type="button" onclick="toggleFaq(this)">
                        Apakah harus berdomisili di Jawa Tengah?
                        <i class="fa-solid fa-chevron-down"></i>
                    </button>
                    <div class="faq-answer">
                        Tidak harus. Namun kegiatan dan jaringan utama saat ini berfokus pada wilayah Jawa Tengah.
                    </div>
                </div>

                <div class="faq-item">
                    <button class="faq-question" type="button" onclick="toggleFaq(this)">
                        Bagaimana cara ikut kegiatan?
                        <i class="fa-solid fa-chevron-down"></i>
                    </button>
                    <div class="faq-answer">
                        Daftar sebagai calon member melalui form. Admin akan menghubungi kamu untuk informasi
                        grup, kopdar, touring, dan agenda komunitas berikutnya.
                    </div>
                </div>

                <div class="faq-item">
                    <button class="faq-question" type="button" onclick="toggleFaq(this)">
                        Apakah wajib membeli jaket komunitas?
                        <i class="fa-solid fa-chevron-down"></i>
                    </button>
                    <div class="faq-answer">
                        Detail ketentuan atribut dapat ditanyakan langsung kepada admin Wacana Style.
                        Pesanan jaket di website ini merupakan fasilitas pemesanan, bukan pengganti proses verifikasi member.
                    </div>
                </div>

                <div class="faq-item">
                    <button class="faq-question" type="button" onclick="toggleFaq(this)">
                        Bagaimana menjaga etika di komunitas?
                        <i class="fa-solid fa-chevron-down"></i>
                    </button>
                    <div class="faq-answer">
                        Saling menghargai, menjaga ucapan dan tindakan, menjaga nama baik Wacana Style,
                        menjaga solidaritas, serta bercanda tanpa melewati batas.
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="footer-grid">
            <div class="footer-brand">
                <div class="brand">
                    <div class="brand-mark"><i class="fa-solid fa-motorcycle"></i></div>
                    <div>WACANA STYLE<small>COMMUNITY • JAWA TENGAH</small></div>
                </div>
                <p>
                    Komunitas motor yang mengutamakan kebersamaan, perjalanan,
            ...
            <div>
                ...
                <div class="footer-links">
                    ...
                    <a href="#map">Peta Komunitas</a>
                    <a href="#gallery">Galeri</a>
                    <a href="#join">Gabung Member</a>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="footer-links">
                    <a href="https://wa.me/6287814693521" target="_blank" rel="noopener">
                        <i class="fa-brands fa-whatsapp"></i> WhatsApp Admin
                    </a>
                    <a href="#faq">FAQ</a>
                    <a href="#jacket">Jaket Wacana Style</a>
                </div>
            </div>
        </div>

        <div class="copyright">
            <span>© {{ date('Y') }} Wacana Style. All rights reserved.</span>
            <span>Satu Aspal • Satu Keluarga</span>
        </div>
    </div>
</footer>
...
<aside id="sideDrawer" class="side-drawer" aria-label="Menu">
    ...
    <div class="drawer-links">
        ...
        <a href="#about" onclick="toggleDrawer(false)">Tentang Kami</a>
        <a href="#map" onclick="toggleDrawer(false)">Peta Komunitas</a>
        <a href="#gallery" onclick="toggleDrawer(false)">Galeri</a>
        <a href="#member" onclick="toggleDrawer(false)">Open Member</a>
        <a href="#join" onclick="toggleDrawer(false)">Daftar Member</a>
        <a href="#jacket" onclick="toggleDrawer(false)">Pesan Jaket</a>
        <a href="#faq" onclick="toggleDrawer(false)">FAQ</a>
    </div>

    <div class="drawer-cta">
        <a href="#join" class="btn btn-red" style="width:100%" onclick="toggleDrawer(false)">
...
<!-- JACKET MODAL -->
<div id="jacketModal" class="modal" role="dialog" aria-modal="true">
    <div class="modal-card">
        <button class="modal-close" type="button" onclick="closeJacketModal()">
            <i class="fa-solid fa-xmark"></i>
        </button>

        <h3>Pesan Jaket Wacana Style</h3>
        <p>
            Isi data pemesanan. Untuk saat ini pesanan diteruskan melalui WhatsApp admin.
        </p>

        <form id="jacketForm">
            <div class="field">
                <label for="jacketName">Nama Lengkap</label>
                <input id="jacketName" type="text" placeholder="Nama kamu" required>
            </div>

            <div class="field">
                <label for="jacketPhone">WhatsApp</label>
                <input id="jacketPhone" type="tel" placeholder="08xxxxxxxxxx" required>
            </div>

            <div class="field">
                <label>Ukuran</label>
                <select id="jacketSize" required>
                    <option value="S">S</option>
                    <option value="M">M</option>
                    <option value="L">L</option>
                    <option value="XL">XL (+Rp15.000)</option>
                </select>
            </div>

            <div class="field">
                <label for="jacketQty">Jumlah</label>
                <input id="jacketQty" type="number" min="1" max="100" value="1" required>
            </div>

            <div class="receipt">
                <div class="receipt-row">
                    <span>Harga / pcs</span>
                    <span id="modalUnitPrice">Rp 180.000</span>
                </div>
                <div class="receipt-row">
                    <span>Jumlah</span>
                    <span id="modalQty">1 pcs</span>
                </div>
                <div class="receipt-row">
                    <span>Total</span>
                    <span id="modalTotal" style="color:#f87171">Rp 180.000</span>
                </div>
            </div>

            <button id="jacketSubmit" type="submit" class="btn btn-red" style="width:100%;margin-top:18px">
...
<script>
    ...
    /* ==========================================================
       WHATSAPP MEMBER FORM
       ========================================================== */
    const waAdmins = [
        {nama:"Putra", nomor:"6287814693521"},
        {nama:"Dafa", nomor:"6289520273357"},
        {nama:"Arinta", nomor:"6283871992716"},
        {nama:"Indra", nomor:"6288227908397"}
    ];
    ...
    document.getElementById('joinForm').addEventListener('submit',function(event){
        ...
        text.textContent = 'Mempersiapkan...';

        const message =
            "🚨 *WACANA STYLE - PENDAFTARAN BARU* 🚨\n\n" +
            "👤 *Nama:* " + name + "\n" +
            "📞 *Kontak HP:* " + contact + "\n" +
            "🏍️ *Jenis Motor:* " + scooter + "\n" +
            "📍 *Domisili:* " + domisili + "\n\n" +
            "_Pendaftaran dikirim dari website Wacana Style._";

        const encodedMessage = encodeURIComponent(message);

        /*
         * Browser dapat memblokir beberapa popup.
         * Karena itu admin dibuka bertahap.
         */
        waAdmins.forEach(function(admin,index){
            setTimeout(function(){
                window.open(
                    'https://wa.me/' + admin.nomor + '?text=' + encodedMessage,
                    '_blank',
                    'noopener'
                );
            },index * 700);
    ...
    function openJacketModal(){
        document.getElementById('jacketModal').classList.add('open');
        document.body.classList.add('modal-open');

        document.getElementById('jacketSize').value = selectedSize;
        document.getElementById('jacketQty').value = jacketQty;
        updateModalFromForm();
    }

    function closeJacketModal(){
        document.getElementById('jacketModal').classList.remove('open');
        document.body.classList.remove('modal-open');
    }

    function updateModalFromForm(){
        const size = document.getElementById('jacketSize').value;
        const qty = Math.max(1,Math.min(100,parseInt(document.getElementById('jacketQty').value,10) || 1));
        const extra = size === 'XL' ? 15000 : 0;
    ...
    document.getElementById('jacketSize').addEventListener('change',updateModalFromForm);
    document.getElementById('jacketQty').addEventListener('input',updateModalFromForm);

    document.getElementById('jacketForm').addEventListener('submit',function(event){
        event.preventDefault();

        const name = document.getElementById('jacketName').value.trim();
        const phone = document.getElementById('jacketPhone').value.trim();
        const size = document.getElementById('jacketSize').value;
        const qty = Math.max(1,Math.min(100,parseInt(document.getElementById('jacketQty').value,10) || 1));
        ...
        const message =
            "🧥 *WACANA STYLE - PEMESANAN JAKET*\n\n" +
            "👤 *Nama:* " + name + "\n" +
            "📱 *WhatsApp:* " + phone + "\n" +
            "📏 *Ukuran:* " + size + "\n" +
            "🔢 *Jumlah:* " + qty + " pcs\n" +
            "💰 *Harga/pcs:* " + rupiah(unit) + "\n" +
            "💵 *Total:* " + rupiah(total) + "\n\n" +
            "Pesanan dikirim dari website Wacana Style.";

        const url = 'https://wa.me/' + waAdmins[0].nomor + '?text=' + encodeURIComponent(message);
        ...
        showStatus(
            true,
            'Pesanan Disiapkan',
            'WhatsApp admin telah dibuka. Silakan lanjutkan pengiriman pesan di WhatsApp.'
        );

        document.getElementById('jacketForm').reset();
        document.getElementById('jacketQty').value = 1;
        selectedSize = 'S';
        selectedExtra = 0;
        jacketQty = 1;
        updateJacketPrice();
        document.getElementById('qtyValue').textContent = '1 pcs';
    });
